...
fs.readdirSync(resolveApp("src/renderer/windows/")).map((name) => {
  appIndexJs[name] = resolveModule(resolveApp, "src/renderer/windows/" + name + "/index");
});
...
module.exports = {
  ...
  appElectronCodePath: resolveApp("src/main"),
